...
$.fn.coveringBad = function(options) {
	...
	////////////////////////////////
		...
		$handle.append('<span class="left fas fa-chevron-left"></span><span class="right fas fa-chevron-right"/></span>')
		...
		if(settings.direction === "horizontal" ) {
			...
			$changeable.css('border-right', '1px dashed #9e0000');
		} 
					...
					$changeable.css('border-bottom', '1px dashed #9e0000');
